	...
	public final void onEvent(Event event) {
		switch (event) {
			...
			case SUCESSFUL_LOGIN:
				...
				break;
			case BAD_LOGIN:
				JOptionPane.showMessageDialog(getParent(), "Invalid username/password combination." + "\n\n" + "Sazcraft will not work without a premium Minecraft account.", "Bad Login Information!", JOptionPane.WARNING_MESSAGE);
				enableForm();
				break;
			...
			case USER_NOT_PREMIUM:
				JOptionPane.showConfirmDialog(getParent(), "Sazcraft will not work without a premium Minecraft account. We do not encourage piracy!", "Premium Minecraft Account Required", JOptionPane.DEFAULT_OPTION);
				enableForm();
				break;
			...
			case PERMISSION_DENIED:
				JOptionPane.showMessageDialog(getParent(), "Ensure Sazcraft is whitelisted with any antivirus applications.", "Permission Denied!", JOptionPane.WARNING_MESSAGE);
				enableForm();
				break;
		}
	}
	...
	private void showJava15Warning() {
		...
		if (version.startsWith("1.5")) {
			...
			JEditorPane ep = new JEditorPane("text/html", "<html><body style=\"" + style + "\">"
					+ "Sazcraft is not compatible with Java 5."
					+ "<br>"
